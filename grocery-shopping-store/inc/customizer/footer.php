...
$wp_customize->add_setting( 'grocery_shopping_store_copyright_alignment', array(
    'default'           => 'Default',
    'capability'        => 'edit_theme_options',
    'sanitize_callback' => 'grocery_shopping_store_sanitize_copyright_alignment_meta',
) );

$wp_customize->add_control( 'grocery_shopping_store_copyright_alignment', array(
    'label'    => esc_html__( 'Copyright Section Alignment', 'grocery-shopping-store' ),
    'section'  => 'grocery_shopping_store_footer_widget_area',
    'type'     => 'select',
    'choices'  => array(
        'Default' => esc_html__( 'Default View', 'grocery-shopping-store' ),
        'Reverse' => esc_html__( 'Reverse View', 'grocery-shopping-store' ),
        'Center'  => esc_html__( 'Centered Content', 'grocery-shopping-store' ),
    ),
) );
...
$wp_customize->add_setting('grocery_shopping_store_footer_widget_background_image',array(
    'default'   => '',
    'sanitize_callback' => 'esc_url_raw',
));
$wp_customize->add_control( new WP_Customize_Image_Control($wp_customize,'grocery_shopping_store_footer_widget_background_image',array(
    'label' => __('Footer Widget Background Image','grocery-shopping-store'),
    'section' => 'grocery_shopping_store_footer_widget_area'
)));

$wp_customize->add_setting('grocery_shopping_store_enable_to_the_top',
    array(
        'default' => $grocery_shopping_store_default['grocery_shopping_store_enable_to_the_top'],
        'capability' => 'edit_theme_options',
        'sanitize_callback' => 'grocery_shopping_store_sanitize_checkbox',
    )
);
$wp_customize->add_control('grocery_shopping_store_enable_to_the_top',
    array(
        'label' => esc_html__('Enable To The Top', 'grocery-shopping-store'),
        'section' => 'grocery_shopping_store_footer_widget_area',
        'type' => 'checkbox',
    )
);

$wp_customize->add_setting( 'grocery_shopping_store_to_the_top_text',
    array(
    'default'           => $grocery_shopping_store_default['grocery_shopping_store_to_the_top_text'],
    'capability'        => 'edit_theme_options',
    'sanitize_callback' => 'sanitize_text_field',
    )
);
$wp_customize->add_control( 'grocery_shopping_store_to_the_top_text',
    array(
    'label'    => esc_html__( 'Edit Text Here', 'grocery-shopping-store' ),
    'section'  => 'grocery_shopping_store_footer_widget_area',
    'type'     => 'text',
    )
);