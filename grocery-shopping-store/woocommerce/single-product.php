...
$grocery_shopping_store_sidebar_column_class = ($grocery_shopping_store_layout === 'right-sidebar') ? 'column-order-1' : 'column-order-2';
?>
	...
	<div class="wrapper">
		<div class="column-row <?php echo esc_attr($grocery_shopping_store_layout === 'no-sidebar' ? 'no-sidebar-layout' : ''); ?>">
			...
			<?php
					 ...
					 */
					if ($grocery_shopping_store_layout !== 'no-sidebar') : do_action('woocommerce_sidebar'); endif;
