...
$grocery_shopping_store_sticky = get_theme_mod('grocery_shopping_store_sticky');
$grocery_shopping_store_data_sticky = "false";
if ($grocery_shopping_store_sticky) {
$grocery_shopping_store_data_sticky = "true";
}
?>

<section id="center-header" class="Stickyy <?php if( is_user_logged_in() && !isset( $wp_customize ) ){ echo "login-user";} ?>" data-sticky="<?php echo esc_attr($grocery_shopping_store_data_sticky); ?>">
