...
function grocery_shopping_store_sanitize_choices( $grocery_shopping_store_input, $grocery_shopping_store_setting ) {
    global $wp_customize;
    $grocery_shopping_store_control = $wp_customize->get_control( $grocery_shopping_store_setting->id );
    if ( array_key_exists( $grocery_shopping_store_input, $grocery_shopping_store_control->choices ) ) {
        return $grocery_shopping_store_input;
    } else {
        return $grocery_shopping_store_setting->default;
    }
}